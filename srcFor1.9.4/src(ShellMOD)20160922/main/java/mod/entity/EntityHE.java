...
public abstract class EntityHE extends EntityShell{
	...
	public static final DataParameter<Byte> fuseParam=EntityDataManager.<Byte>createKey(EntityHE.class,DataSerializers.BYTE);
	
	public EntityHE(World par1World) {
		super(par1World);
        fuse=-1;
        this.dataManager.register(this.fuseParam, this.fuse);
	}
	...
	public void onUpdate(){
		...
		if(this.fuse>0){
			this.fuse--;
			this.dataManager.set(this.fuseParam, this.fuse);
		}else if(this.fuse==0){
