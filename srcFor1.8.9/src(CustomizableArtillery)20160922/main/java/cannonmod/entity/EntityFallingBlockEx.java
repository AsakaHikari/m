...
public class EntityFallingBlockEx extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        if (this.fallTile.getBlock().getMaterial() == Material.air)
        {
            this.setDead();
        }
        else
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (this.onGround)
                {
                    ...
                    if (this.worldObj.getBlockState(blockpos1).getBlock() != Blocks.piston_extension)
                    {
                        ...
                        if(!(BlockFalling.canFallInto(this.worldObj, new BlockPos(i, j - 1, k)) && this.motionX*this.motionX+this.motionZ+this.motionZ>0.1)){
