...
public class CannonCore {
	...
	public static final String MOD_ID="simpleArtilleryMod";
	...
	public void preInit(FMLPreInitializationEvent e){
		...
		itemArmor=new ItemArmorPlate().setUnlocalizedName("ArmorPlate").setCreativeTab(CreativeTabs.tabMaterials);
		GameRegistry.registerItem(itemArmor,"ArmorPlate");
		
		itemCannon=new ItemCannon().setUnlocalizedName("Cannon").setCreativeTab(CreativeTabs.tabMaterials);
		GameRegistry.registerItem(itemCannon,"Cannon");
		
		itemBarrel=new ItemBarrel().setUnlocalizedName("Barrel").setCreativeTab(CreativeTabs.tabMaterials);
		GameRegistry.registerItem(itemBarrel,"Barrel");
		
		itemCarriage=new ItemCarriage().setUnlocalizedName("Carriage").setCreativeTab(CreativeTabs.tabMaterials);
		GameRegistry.registerItem(itemCarriage,"Carriage");
		
		itemEngine=new ItemEngine().setUnlocalizedName("Engine").setCreativeTab(CreativeTabs.tabMaterials);
		GameRegistry.registerItem(itemEngine,"Engine");
		
		itemTrack=new ItemTrack().setUnlocalizedName("Track").setCreativeTab(CreativeTabs.tabMaterials);
		GameRegistry.registerItem(itemTrack,"Track");
		
		itemChassis=new ItemChassis().setUnlocalizedName("Chassis").setCreativeTab(CreativeTabs.tabMaterials);
