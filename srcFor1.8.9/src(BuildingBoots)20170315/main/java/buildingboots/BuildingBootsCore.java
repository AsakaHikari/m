...
/*    */public class BuildingBootsCore{
	...
	/* 28 */public static ItemArmor.ArmorMaterial BUILDING1 = EnumHelper
			.addArmorMaterial("BuildingArmorMaterial","buildingbootsmod:building_boots_0", 1000, new int[] { 0, 0, 0,0 }, 0);
	public static ItemArmor.ArmorMaterial BUILDING2 = EnumHelper
			.addArmorMaterial("BuildingArmorMaterial","buildingbootsmod:building_boots_1", 1000, new int[] { 0, 0, 0,0 }, 0);
	public static ItemArmor.ArmorMaterial BUILDING3 = EnumHelper
			.addArmorMaterial("BuildingArmorMaterial","buildingbootsmod:building_boots_2", 1000, new int[] { 0, 0, 0,0 }, 0);
	...
	/*    */{
		 ...
		 */
		itembuildingboots_0 = new ItemBuildingBoots(BUILDING1, 0, 3,0)
		...
		itembuildingboots_1 = new ItemBuildingBoots(BUILDING2, 0, 3,1)
		...
		itembuildingboots_2 = new ItemBuildingBoots(BUILDING3, 0, 3,2)
