...
{
	public int type;
	public ItemBuildingBoots(ItemArmor.ArmorMaterial p_i45325_1_, int p_i45325_2_, int p_i45325_3_,int type)
	{
	...
	public static double getMaxY(World w,Entity e,int x,int y,int z){
		...
		id.addCollisionBoxesToList(w,pos,w.getBlockState(pos), new AxisAlignedBB(x, y, z, x+1, y+1, z+1), list, e);
		if(list.isEmpty()){
			return y-1;
		}
