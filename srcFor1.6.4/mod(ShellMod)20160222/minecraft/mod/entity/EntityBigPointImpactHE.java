...
public class EntityBigPointImpactHE extends EntityHE{
	public EntityBigPointImpactHE(World par1World) {
		super(par1World);
	...
	public EntityBigPointImpactHE(World par1World, double par2, double par4, double par6)
    {
		this(par1World);
