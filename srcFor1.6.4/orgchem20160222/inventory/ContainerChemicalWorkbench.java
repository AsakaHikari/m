...
public class ContainerChemicalWorkbench extends Container{
	   /** The crafting matrix inventory (3x3). */
    public InventoryChemicalCrafting craftMatrix = new InventoryChemicalCrafting(this);
    public IInventory craftResult = new InventoryChemicalCraftResult();
    private World worldObj;
    private int posX;
    private int posY;
    private int posZ;

    public ContainerChemicalWorkbench(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5)
    {
    ...
    {
        this.craftResult.setInventorySlotContents(0, craftMatrix.getCraftResult());
    }
