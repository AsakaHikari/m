...
public class ModelSniperSkeleton extends ModelZombie
{
    public ModelSniperSkeleton()
    {
        this(0.0F);
    }

    public ModelSniperSkeleton(float par1)
    {
    ...
    {
        this.aimedBow = ((EntitySniperSkeleton)par1EntityLivingBase).getSkeletonType() == 1;
