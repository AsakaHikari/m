...
public class BlockRailDetector extends BlockRailBase
{
    ...
    private void func_150054_a(World p_150054_1_, int p_150054_2_, int p_150054_3_, int p_150054_4_, int p_150054_5_)
    {
        ...
        boolean flag1 = false;
        float f = 0.125F;
        List list = p_150054_1_.getEntitiesWithinAABB(EntityMinecartRapid.class, AxisAlignedBB.getBoundingBox((double)((float)p_150054_2_ + f), (double)p_150054_3_, (double)((float)p_150054_4_ + f), (double)((float)(p_150054_2_ + 1) - f), (double)((float)(p_150054_3_ + 1) - f), (double)((float)(p_150054_4_ + 1) - f)));
