...
public class RenderFallingBlockEx extends Render
{
     ...
     */
    public void doRender(EntityFallingBlockEx p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        ...
        System.out.println("block:"+(block==null?"null":block.getClass().toString()));
        if (block != null && block != world.getBlock(i, j, k))
        {
            ...
            if (block instanceof BlockAnvil)
            {
                ...
                this.field_147920_a.renderBlockAnvilMetadata((BlockAnvil)block, i, j, k, p_76986_1_.blockMetadata);
            ...
            else
            {
                ...
                this.field_147920_a.renderBlockSandFalling(block, world, i, j, k, p_76986_1_.blockMetadata);
            }
    ...
    {
        return this.getEntityTexture((EntityFallingBlockEx)p_110775_1_);
    }
    ...
    {
        this.doRender((EntityFallingBlockEx)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}