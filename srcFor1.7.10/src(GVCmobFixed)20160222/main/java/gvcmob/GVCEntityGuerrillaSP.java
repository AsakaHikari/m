...
public class GVCEntityGuerrillaSP extends EntityMob implements IRangedAttackMob
{
    ...
    protected void addRandomArmor()
    {
        ...
        this.setCurrentItemOrArmor(0, new ItemStack(GVCGunsPlus.fn_svd));
    }
    ...
    public void setCombatTask()
    {
        ...
        if (var1 != null && var1.getItem() == GVCGunsPlus.fn_svd)
        {
            this.tasks.addTask(4, this.aiArrowAttack);
        }
        else
