...
public class GVCEntityMobSpawner extends EntityMob implements IRangedAttackMob
{
	private EntityAIArrowAttack aiArrowAttack = new EntityAIArrowAttack(this, 1.0D, 40, 40, 30.0F);
    ...
    {
    	GVCEntityBulletMobSpawn var3 = new GVCEntityBulletMobSpawn(this.worldObj, this);
