...
public class GVCEntityGuerrillaMG extends EntityMob implements IRangedAttackMob
{
	private EntityAIArrowAttack aiArrowAttack = new EntityAIArrowAttack(this, 1.0D, 3, 3, 25.0F);
    ...
    {
        return GVCGunsPlus.fn_magazinemg;
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        for (var4 = 0; var4 < var3; ++var4)
        {
            this.dropItem(GVCGunsPlus.fn_magazinemg, 1);
        }
    }
    ...
    protected void addRandomArmor()
    {
        ...
        this.setCurrentItemOrArmor(0, new ItemStack(GVCGunsPlus.fn_pkm));
    }
    ...
    public void setCombatTask()
    {
        ...
        if (var1 != null && var1.getItem() == GVCGunsPlus.fn_pkm)
        {
            this.tasks.addTask(4, this.aiArrowAttack);
        }
        else
