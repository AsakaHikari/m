...
public class GVCEntitySoldier extends EntityGolem implements IRangedAttackMob
{
	//private static final EntityCreature EntityCreature = null;
	private EntityAIArrowAttack aiArrowAttack = new EntityAIArrowAttack(this, 1.0D, 4, 4, 15.0F);
    ...
    public GVCEntitySoldier(World par1World)
    {
        ...
        this.tasks.addTask(1, new EntityAIArrowAttack(this, 1.0D, 4, 4, 15.0F));
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase par1EntityLivingBase, float par2)
    {
        ...
        if (this.worldObj.rand.nextInt(10) == 0)
        {
            ...
            this.playSound("gvcmob:gvcmob.grenade", 1.5F, 1.0F);
