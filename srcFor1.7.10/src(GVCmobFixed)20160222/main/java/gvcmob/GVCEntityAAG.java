...
public class GVCEntityAAG extends EntityMob implements IRangedAttackMob
{
	private EntityAIArrowAttack aiArrowAttack = new EntityAIArrowAttack(this, 1.0D, 10, 10, 80.0F);
    ...
    public boolean getCanSpawnHere()
    {
    	...
    	return this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL  && this.worldObj.getFullBlockLightValue(i, j, k) >= 0;
    }
