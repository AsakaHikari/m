...
public class GVCEntityGuerrillaRPG extends EntityMob implements IRangedAttackMob
{
	private EntityAIArrowAttack aiArrowAttack = new EntityAIArrowAttack(this, 1.0D, 60, 60, 30.0F);
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase par1EntityLivingBase, float par2)
    {
        ...
        double var6 = par1EntityLivingBase.posY + (double)par1EntityLivingBase.getEyeHeight() - 1.500000023841858D - var3.posY;
    ...
    public void onLivingUpdate()
    {
        ...
        int j = MathHelper.floor_double(this.posZ);
            ...
            int k1 =      this.worldObj.getHeightValue(j,l );

            if (!this.worldObj.isRemote)
            {
            	//if(mod_GVC_GuerrillaVsCommandmob.cfg_SetIED == true)
            	if(GVCMobPlus.cfg_cansetIED == true)
            	{
            		if(this.worldObj.getBlock(j+1, k, l+1) == Blocks.air){
            	switch (this.rand.nextInt(400))
                { 
            	  case 0:
                  this.worldObj.setBlock(j+1, k, l+1, GVCGunsPlus.fn_ied);
                  break;
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        for (var4 = 0; var4 < var3; ++var4)
        {
            this.dropItem(GVCGunsPlus.fn_rpg, 1);
        }
    }
    ...
    public void setCombatTask()
    {
        ...
        if (var1 != null && var1.getItem() == GVCGunsPlus.fn_rpg7)
        {
            this.tasks.addTask(4, this.aiArrowAttack);
        }
        else
