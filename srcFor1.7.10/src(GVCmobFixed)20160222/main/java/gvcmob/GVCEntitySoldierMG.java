...
public class GVCEntitySoldierMG extends EntityGolem implements IRangedAttackMob
{
    ...
    public GVCEntitySoldierMG(World par1World)
    {
        ...
        this.tasks.addTask(1, new EntityAIArrowAttack(this, 1.0D, 3, 3, 25.0F));
    ...
    protected void addRandomArmor()
    {
        ...
        this.setCurrentItemOrArmor(0, new ItemStack(GVCGunsPlus.fn_m240b));
    }
