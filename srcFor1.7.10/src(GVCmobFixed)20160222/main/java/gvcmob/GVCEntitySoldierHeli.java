...
public class GVCEntitySoldierHeli extends EntityGolem implements IRangedAttackMob
{
    ...
    public void onDeath(DamageSource par1DamageSource)
    {
        ...
        {
        	GVCEntitySoldier entityskeleton = new GVCEntitySoldier(this.worldObj);
        entityskeleton.setLocationAndAngles(this.posX+2, this.posY+3, this.posZ, this.rotationYaw, 0.0F);
        entityskeleton.setCurrentItemOrArmor(0, new ItemStack(GVCGunsPlus.fn_m16a4));
        this.worldObj.spawnEntityInWorld(entityskeleton);
        
        GVCEntitySoldier entityskeleton2 = new GVCEntitySoldier(this.worldObj);
        entityskeleton2.setLocationAndAngles(this.posX-2, this.posY+3, this.posZ, this.rotationYaw, 0.0F);
        entityskeleton2.setCurrentItemOrArmor(0, new ItemStack(GVCGunsPlus.fn_m16a4));
