...
public class GVCEntityBulletBase extends EntityThrowable
{
	...
	public GVCEntityBulletBase(World par1World)
    {
        super(par1World);
        //this.fuse = 30;
    }

    public GVCEntityBulletBase(World par1World, EntityLivingBase par2EntityLivingBase)
    {
    ...
    public GVCEntityBulletBase(World par1World, double par2, double par4, double par6)
    {
    ...
    public void onUpdate()
    {
        ...
        this.worldObj.playSoundAtEntity(this, "gvcguns:gvcguns.bullethit", 1.0F, 1.0F);
        }
