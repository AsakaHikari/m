...
public class GVCEntitySoldierTank extends EntityGolem implements IRangedAttackMob
{
    ...
    public GVCEntitySoldierTank(World par1World)
    {
        ...
        this.tasks.addTask(1, new EntityAIArrowAttack(this, 1.0D, 60, 60, 30.0F));
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2)
    {
    	...
    	if (entity instanceof GVCEntityBulletGe)
        {
    		return false;
        }
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase par1EntityLivingBase, float par2)
    {
        ...
        var3.setThrowableHeading(var4, var6 + (double)var10, var8, 1.6F, 5.0F);
