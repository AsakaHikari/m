...
public class GVCEntityBulletGeSP extends GVCEntityBulletBase
{
	...
	public GVCEntityBulletGeSP(World par1World)
    {
        super(par1World);
        //this.fuse = 30;
    }

    public GVCEntityBulletGeSP(World par1World, EntityLivingBase par2EntityLivingBase)
    {
        ...
        //this.Bspeed = bspeed;
        //this.Bure = bure;
        this.setThrowableHeading(this.motionX, this.motionY, this.motionZ, 4F, 1F);
    }

    public GVCEntityBulletGeSP(World par1World, double par2, double par4, double par6)
    {
    ...
    public void setThrowableHeading(double par1, double par3, double par5, float par7, float par8)
    {
        ...
        par3 /= (double)var9;
        par5 /= (double)var9;
        par1 += this.rand.nextGaussian() * (double)(this.rand.nextBoolean() ? -1 : 1) * 0.000099999832361937D * (double)par8;
        par3 += this.rand.nextGaussian() * (double)(this.rand.nextBoolean() ? -1 : 1) * 0.000099999832361937D * (double)par8;
        par5 += this.rand.nextGaussian() * (double)(this.rand.nextBoolean() ? -1 : 1) * 0.000099999832361937D * (double)par8;
        par1 *= (double)par7;
        par3 *= (double)par7;
        par5 *= (double)par7;
        this.motionX = par1;
