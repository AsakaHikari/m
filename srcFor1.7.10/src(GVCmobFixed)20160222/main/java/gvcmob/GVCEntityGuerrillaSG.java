...
public class GVCEntityGuerrillaSG extends EntityMob implements IRangedAttackMob
{
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        for (var4 = 0; var4 < var3; ++var4)
        {
            this.dropItem(GVCGunsPlus.fn_shell, 8);
        }
    }
    ...
    protected void addRandomArmor()
    {
        ...
        this.setCurrentItemOrArmor(0, new ItemStack(GVCGunsPlus.fn_m870));
    }
    ...
    public void setCombatTask()
    {
        ...
        if (var1 != null && var1.getItem() == GVCGunsPlus.fn_m870)
        {
            this.tasks.addTask(4, this.aiArrowAttack);
        }
        else
