...
public class GVCEntityLaser extends EntityThrowable
{
	...
	public GVCEntityLaser(World par1World)
    {
        super(par1World);
        //this.fuse = 30;
    }

    public GVCEntityLaser(World par1World, EntityLivingBase par2EntityLivingBase)
    {
    ...
    public GVCEntityLaser(World par1World, double par2, double par4, double par6)
    {
