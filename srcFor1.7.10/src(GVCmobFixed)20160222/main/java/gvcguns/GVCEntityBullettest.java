...
public class GVCEntityBullettest extends Entity implements IProjectile
{
    ...
    public GVCEntityBullettest(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public GVCEntityBullettest(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public GVCEntityBullettest(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public GVCEntityBullettest(World p_i1756_1_, EntityLivingBase p_i1756_2_, int damege, float bspeed, float bure)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
