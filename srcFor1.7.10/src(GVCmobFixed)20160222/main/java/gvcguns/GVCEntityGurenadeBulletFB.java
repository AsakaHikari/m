...
public class GVCEntityGurenadeBulletFB extends GVCEntityGurenadeBullet
{
	...
	public GVCEntityGurenadeBulletFB(World par1World)
    {
        super(par1World);
        //this.fuse = 30;
    }

    public GVCEntityGurenadeBulletFB(World par1World, EntityLivingBase par2EntityLivingBase)
    {
        ...
        //this.Bspeed = bspeed;
        //this.Bure = bure;
        this.setThrowableHeading(this.motionX, this.motionY, this.motionZ, 2.0F, 1F);
    }

    public GVCEntityGurenadeBulletFB(World par1World, double par2, double par4, double par6)
    {
...
//			
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            this.setDead();
            if(GVCGunsPlus.cfg_exprotion ==true){
            this.explode();
            }
        }
    ...
    private void explode()
    {
        	...
        	this.worldObj.newExplosion(this, this.posX, this.posY, this.posZ, 2.0F, true, false);
