...
public class GVCEntitySentryBulletAAG extends EntityThrowable
{
	...
	public GVCEntitySentryBulletAAG(World par1World)
    {
        super(par1World);
        //this.fuse = 30;
        this.fuse = 25 + this.worldObj.rand.nextInt(20);
    }

    public GVCEntitySentryBulletAAG(World par1World, EntityLivingBase par2EntityLivingBase)
    {
    ...
    public GVCEntitySentryBulletAAG(World par1World, double par2, double par4, double par6)
    {
