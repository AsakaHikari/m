...
public class GVCEntityBulletG extends EntityThrowable
{
	...
	public GVCEntityBulletG(World par1World)
    {
        super(par1World);
        //this.fuse = 30;
    }

    public GVCEntityBulletG(World par1World, EntityLivingBase par2EntityLivingBase)
    {
    ...
    public GVCEntityBulletG(World par1World, double par2, double par4, double par6)
    {
