...
public class GVCEntityRPGVR extends GVCEntityRPG
{
	...
	public GVCEntityRPGVR(World par1World)
    {
        super(par1World);
        //this.fuse = 30;
    }

    public GVCEntityRPGVR(World par1World, EntityLivingBase par2EntityLivingBase, int damege, float bspeed, float bure, float explv, boolean fb, boolean bb)
    {
    	
    	super(par1World, par2EntityLivingBase, damege, explv, explv, explv, bb, bb);
    ...
    public GVCEntityRPGVR(World par1World, double par2, double par4, double par6)
    {
...
//					worldObj.spawnParticle("snowballpoof", this.posX, this.posY,
	...
	public boolean checkDestroyBlock(MovingObjectPosition var1, int pX, int pY, int pZ, Block pBlock, int pMetadata) {
		if ((pBlock instanceof Block && pBlock ==  pBlock.getBlockById(7))
				) {
			return false;
		}
		return true;
