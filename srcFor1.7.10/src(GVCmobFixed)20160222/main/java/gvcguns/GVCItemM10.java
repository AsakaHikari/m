...
import cpw.mods.fml.relauncher.Side;
	...
	public class GVCItemM10 extends GVCItemGunBase {
		private float field_150934_a;
		
		public GVCItemM10(int p, float s, float b, double r, int rt, float at, float cz) {
			super();
			this.maxStackSize = 1;
		...
		public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4)
		  {
		    ...
		    par3List.add(EnumChatFormatting.WHITE + "FirePowor " + StatCollector.translateToLocal("1200"));
		  }
