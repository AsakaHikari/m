...
public class GVCEntityGurenadeBullet extends EntityThrowable
{
	...
	public GVCEntityGurenadeBullet(World par1World)
    {
        super(par1World);
        //this.fuse = 30;
    }

    public GVCEntityGurenadeBullet(World par1World, EntityLivingBase par2EntityLivingBase)
    {
    ...
    public GVCEntityGurenadeBullet(World par1World, double par2, double par4, double par6)
    {
