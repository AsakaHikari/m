...
public class GVCExplosion extends Explosion
{
    ...
    public GVCExplosion(World p_i1948_1_, Entity p_i1948_2_, double p_i1948_3_, double p_i1948_5_, double p_i1948_7_, float p_i1948_9_)
    {
    	super(p_i1948_1_, p_i1948_2_, p_i1948_7_, p_i1948_7_, p_i1948_7_, p_i1948_9_);
    ...
    public void doExplosionB(boolean p_77279_1_)
    {
        ...
        if (this.isFlaming)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                {
                    this.worldObj.setBlock(i, j, k, Blocks.torch);
                }
            }
        }
    }
