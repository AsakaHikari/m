...
public class GVCEntityBulletFrag extends EntityThrowable
{
	...
	public GVCEntityBulletFrag(World par1World)
    {
        super(par1World);
        //this.fuse = 30;
    }

    public GVCEntityBulletFrag(World par1World, EntityLivingBase par2EntityLivingBase, int damege, float bspeed, float bure)
    {
    ...
    public GVCEntityBulletFrag(World par1World, double par2, double par4, double par6)
    {
...
//			
    ...
    private void explode()
    {
        	...
        	this.worldObj.createExplosion(this, this.posX, this.posY, this.posZ, 1.7F, false);
