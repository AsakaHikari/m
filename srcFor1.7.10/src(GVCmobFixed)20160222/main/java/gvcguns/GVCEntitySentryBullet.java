...
public class GVCEntitySentryBullet extends EntityThrowable
{
	...
	public GVCEntitySentryBullet(World par1World)
    {
        super(par1World);
        //this.fuse = 30;
    }

    public GVCEntitySentryBullet(World par1World, EntityLivingBase par2EntityLivingBase)
    {
    ...
    public GVCEntitySentryBullet(World par1World, double par2, double par4, double par6)
    {
