...
import net.minecraftforge.client.GuiIngameForge;
	...
	public class GVCItemR700 extends GVCItemGunBase {
		private float field_150934_a;
	    

		public GVCItemR700(int p, float s, float b, double r, int rt, float at, float cz) {
			super();
			this.maxStackSize = 1;
		...
		public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4)
		  {
		    ...
		    par3List.add(EnumChatFormatting.WHITE + "ScopeZoom " + StatCollector.translateToLocal("x8"));
