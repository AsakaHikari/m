...
import net.minecraftforge.client.GuiIngameForge;
	...
	public class GVCItemMBTLAW extends GVCItemGunBase {
		private float field_150934_a;
	    

		public GVCItemMBTLAW() {
			setMaxDamage(1);
		...
		public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4)
		  {
		    ...
		    par3List.add(EnumChatFormatting.YELLOW + "MagazimeType " + StatCollector.translateToLocal("Missile"));
		...
		public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
	    {
	        ...
	        if (var5 || par3EntityPlayer.inventory.hasItem(GVCGunsPlus.fn_missile))
	        {
		...
		public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	    {
	        ...
	        if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(GVCGunsPlus.fn_missile))
	        {
		...
		public void FireBulletVL(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) 
		{
            ...
            GVCEntityMissile var8 = new GVCEntityMissile(par2World,(EntityLivingBase) par3EntityPlayer, this.powor, 1.6F, this.bure, 3.0F, false, true);
		...
		public void getReload(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) 
		{
			...
			if (!linfinity) {
			par3EntityPlayer.inventory.consumeInventoryItem(GVCGunsPlus.fn_missile);
			}
