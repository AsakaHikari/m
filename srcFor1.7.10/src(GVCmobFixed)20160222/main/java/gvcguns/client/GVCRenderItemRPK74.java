...
public class GVCRenderItemRPK74 implements IItemRenderer
{
    private GVCModelItemRPK74 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelRPK74.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelRPK74_reload.png"); 
    public GVCRenderItemRPK74()
    {
        modeling = new GVCModelItemRPK74();
    }
    @Override
