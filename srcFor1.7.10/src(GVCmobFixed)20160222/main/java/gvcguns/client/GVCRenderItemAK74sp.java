...
public class GVCRenderItemAK74sp implements IItemRenderer
{
    private GVCModelItemAK74sp modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelAK74sp.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelAK74sp_reload.png"); 
    public GVCRenderItemAK74sp()
    {
        modeling = new GVCModelItemAK74sp();
    }
    @Override
    ...
    private void glMatrixForRenderInEquippedADS()
    {
      ...
      GL11.glTranslatef(0.670F, -1.335F, 1.3F);
    }
