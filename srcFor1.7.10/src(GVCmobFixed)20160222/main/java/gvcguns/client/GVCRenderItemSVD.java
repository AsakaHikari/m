...
public class GVCRenderItemSVD implements IItemRenderer
{
    private GVCModelItemSVD modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelSVD.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelSVD_reload.png"); 
    private static final ResourceLocation skeletonTextures3 = new ResourceLocation("gvcguns:textures/model/modelSVD_ads.png"); 
    public GVCRenderItemSVD()
    {
        modeling = new GVCModelItemSVD();
    }
    @Override
