...
public class GVCRenderItemP226 implements IItemRenderer
{
    private GVCModelItemM1911 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelP226.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelP226_reload.png"); 
    public GVCRenderItemP226()
    {
