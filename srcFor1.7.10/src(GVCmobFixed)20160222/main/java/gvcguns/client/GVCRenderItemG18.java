...
public class GVCRenderItemG18 implements IItemRenderer
{
    private GVCModelItemM1911 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelG18.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelG18_reload.png"); 
    public GVCRenderItemG18()
    {
