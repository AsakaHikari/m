...
public class GVCRenderItemM10 implements IItemRenderer
{
    private GVCModelItemM10 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelM10.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelM10_reload.png"); 
    public GVCRenderItemM10()
    {
        modeling = new GVCModelItemM10();
    }
    @Override
