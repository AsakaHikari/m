...
public class GVCRenderItemM320 implements IItemRenderer
{
    private GVCModelItemM320 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelM320.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelM320_reload.png"); 
    
    private static final ResourceLocation skeletonTextures00 = new ResourceLocation("gvcguns:textures/model/modelM320_he.png"); 
    private static final ResourceLocation skeletonTextures01 = new ResourceLocation("gvcguns:textures/model/modelM320_dart.png"); 
    private static final ResourceLocation skeletonTextures02 = new ResourceLocation("gvcguns:textures/model/modelM320_lvg.png"); 
    private static final ResourceLocation skeletonTextures03 = new ResourceLocation("gvcguns:textures/model/modelM320_fb.png"); 
    public GVCRenderItemM320()
    {
        modeling = new GVCModelItemM320();
    }
    @Override
