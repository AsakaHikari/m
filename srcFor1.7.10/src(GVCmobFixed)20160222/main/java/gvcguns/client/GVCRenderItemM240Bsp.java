...
public class GVCRenderItemM240Bsp implements IItemRenderer
{
    private GVCModelItemM240B modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelM240B.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelM240B_reload.png"); 
    public GVCRenderItemM240Bsp()
    {
        modeling = new GVCModelItemM240B();
    }
    @Override
    ...
    private void glMatrixForRenderInEquippedADS()
    {
      ...
      GL11.glTranslatef(0.670F, -1.350F, 1.0F);
    }
