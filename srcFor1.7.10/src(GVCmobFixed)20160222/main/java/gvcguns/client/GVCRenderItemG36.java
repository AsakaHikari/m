...
public class GVCRenderItemG36 implements IItemRenderer
{
    private GVCModelItemG36 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelG36.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelG36_reload.png"); 
    public GVCRenderItemG36()
    {
        modeling = new GVCModelItemG36();
    }
    @Override
