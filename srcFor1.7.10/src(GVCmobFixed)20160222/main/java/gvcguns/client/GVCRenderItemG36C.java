...
public class GVCRenderItemG36C implements IItemRenderer
{
    private GVCModelItemG36C modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelG36C.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelG36C_reload.png"); 
    public GVCRenderItemG36C()
    {
        modeling = new GVCModelItemG36C();
    }
    @Override
    ...
    private void glMatrixForRenderInEquippedADS()
    {
      ...
      GL11.glTranslatef(0.6685F, -1.294F, 1.3F);
    }
