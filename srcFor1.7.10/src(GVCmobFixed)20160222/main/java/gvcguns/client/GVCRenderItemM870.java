...
import gvcguns.GVCItemGunBaseSG;
...
public class GVCRenderItemM870 implements IItemRenderer
{
    private GVCModelItemM870 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelM870.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelM870_reload.png"); 
    
    private static final ResourceLocation skeletonTextures00 = new ResourceLocation("gvcguns:textures/model/modelM870_b.png"); 
    private static final ResourceLocation skeletonTextures01 = new ResourceLocation("gvcguns:textures/model/modelM870_dart.png"); 
    private static final ResourceLocation skeletonTextures02 = new ResourceLocation("gvcguns:textures/model/modelM870_frag.png"); 
    private static final ResourceLocation skeletonTextures03 = new ResourceLocation("gvcguns:textures/model/modelM870_srag.png"); 
    public GVCRenderItemM870()
    {
        modeling = new GVCModelItemM870();
    }
    @Override
    ...
    private void glMatrixForRenderInEquippedADS()
    {
      ...
      GL11.glTranslatef(0.670F, -1.455F, 1.0F);
    }
