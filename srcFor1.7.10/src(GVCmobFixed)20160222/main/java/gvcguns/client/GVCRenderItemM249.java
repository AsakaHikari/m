...
public class GVCRenderItemM249 implements IItemRenderer
{
    private GVCModelItemM249 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelM249.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelM249_reload.png"); 
    public GVCRenderItemM249()
    {
        modeling = new GVCModelItemM249();
    }
    @Override
    ...
    private void glMatrixForRenderInEquippedADS()
    {
      ...
      GL11.glTranslatef(0.670F, -1.400F, 1.0F);
    }
