...
public class GVCRenderItemAKS74U implements IItemRenderer
{
    private GVCModelItemAKS74U modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelAKS74U.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelAKS74U_reload.png"); 
    public GVCRenderItemAKS74U()
    {
        modeling = new GVCModelItemAKS74U();
    }
    @Override
