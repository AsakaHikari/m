...
public class GVCRenderItemCBJ implements IItemRenderer
{
    private GVCModelItemCBJ modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelCBJ.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelCBJ_reload.png"); 
    public GVCRenderItemCBJ()
    {
        modeling = new GVCModelItemCBJ();
    }
    @Override
