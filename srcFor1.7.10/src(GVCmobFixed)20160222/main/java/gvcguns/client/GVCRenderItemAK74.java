...
public class GVCRenderItemAK74 implements IItemRenderer
{
    private GVCModelItemAK74 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelAK74.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelAK74_reload.png"); 
    public GVCRenderItemAK74()
    {
        modeling = new GVCModelItemAK74();
    }
    @Override
