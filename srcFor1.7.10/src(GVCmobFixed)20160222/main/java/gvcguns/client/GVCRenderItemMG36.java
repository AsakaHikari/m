...
public class GVCRenderItemMG36 implements IItemRenderer
{
    private GVCModelItemMG36 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelMG36.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelMG36_reload.png"); 
    public GVCRenderItemMG36()
    {
        modeling = new GVCModelItemMG36();
    }
    @Override
