...
public class GVCRenderItemM9 implements IItemRenderer
{
    private GVCModelItemM9 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelM9.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelM9_reload.png"); 
    public GVCRenderItemM9()
    {
        modeling = new GVCModelItemM9();
    }
    @Override
