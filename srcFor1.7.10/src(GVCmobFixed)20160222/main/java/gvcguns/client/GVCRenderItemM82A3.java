...
public class GVCRenderItemM82A3 implements IItemRenderer
{
    private GVCModelItemM82A3 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelM82A3.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelM82A3_reload.png"); 
    private static final ResourceLocation skeletonTextures3 = new ResourceLocation("gvcguns:textures/model/modelM82A3_ads.png"); 
    public GVCRenderItemM82A3()
    {
        modeling = new GVCModelItemM82A3();
    }
    @Override
