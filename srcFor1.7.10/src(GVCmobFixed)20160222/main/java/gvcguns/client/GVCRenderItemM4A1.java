...
public class GVCRenderItemM4A1 implements IItemRenderer
{
    private GVCModelItemM4A1 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelM4A1.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelM4A1_reload.png"); 
    public GVCRenderItemM4A1()
    {
        modeling = new GVCModelItemM4A1();
    }
    @Override
