...
public class GVCRenderItemUZI implements IItemRenderer
{
    private GVCModelItemUZI modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelUZI.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelUZI_reload.png"); 
    public GVCRenderItemUZI()
    {
        modeling = new GVCModelItemUZI();
    }
    @Override
