...
public class GVCRenderItemRPG7 implements IItemRenderer
{
    private GVCModelItemRPG7 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelRPG7.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelRPG7_reload.png"); 
    
    private static final ResourceLocation skeletonTextures00 = new ResourceLocation("gvcguns:textures/model/modelRPG7_he.png"); 
    private static final ResourceLocation skeletonTextures01 = new ResourceLocation("gvcguns:textures/model/modelRPG7_dart.png"); 
    private static final ResourceLocation skeletonTextures02 = new ResourceLocation("gvcguns:textures/model/modelRPG7_lvg.png"); 
    private static final ResourceLocation skeletonTextures03 = new ResourceLocation("gvcguns:textures/model/modelRPG7_fb.png"); 
    public GVCRenderItemRPG7()
    {
        modeling = new GVCModelItemRPG7();
    }
    @Override
    ...
    private void glMatrixForRenderInEquippedADS()
    {
      ...
      GL11.glTranslatef(0.670F, -1.43F, 1.0F);
    }
