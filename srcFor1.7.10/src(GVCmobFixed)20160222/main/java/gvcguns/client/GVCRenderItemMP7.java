...
public class GVCRenderItemMP7 implements IItemRenderer
{
    private GVCModelItemMP7 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelMP7.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelMP7_reload.png"); 
    public GVCRenderItemMP7()
    {
        modeling = new GVCModelItemMP7();
    }
    @Override
    ...
    private void glMatrixForRenderInEquippedADS()
    {
      ...
      GL11.glTranslatef(0.670F, -1.34F, 1.0F);
    }
