...
public class GVCRenderItemG17 implements IItemRenderer
{
    private GVCModelItemM1911 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelG17.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelG17_reload.png"); 
    public GVCRenderItemG17()
    {
