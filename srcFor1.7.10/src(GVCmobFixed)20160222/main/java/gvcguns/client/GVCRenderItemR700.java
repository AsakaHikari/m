...
public class GVCRenderItemR700 implements IItemRenderer
{
    private GVCModelItemR700 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelR700.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelR700_reload.png"); 
    private static final ResourceLocation skeletonTextures3 = new ResourceLocation("gvcguns:textures/model/modelR700_ads.png"); 
    public GVCRenderItemR700()
    {
        modeling = new GVCModelItemR700();
    }
    @Override
