...
public class GVCRenderItemM1911 implements IItemRenderer
{
    private GVCModelItemM1911 modeling;
    private static final ResourceLocation skeletonTextures = new ResourceLocation("gvcguns:textures/model/modelM1911.png"); 
    private static final ResourceLocation skeletonTextures2 = new ResourceLocation("gvcguns:textures/model/modelM1911_reload.png"); 
    public GVCRenderItemM1911()
    {
        modeling = new GVCModelItemM1911();
    }
    @Override
