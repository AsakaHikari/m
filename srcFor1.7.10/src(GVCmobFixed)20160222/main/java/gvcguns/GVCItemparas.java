...
public class GVCItemparas extends Item
{
	public GVCItemparas()
    {
        super();
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            GVCEntityparas entityskeleton = new GVCEntityparas(par3World);
            entityskeleton.setLocationAndAngles(par4, par5, par6, var12, 0.0F);
