...
public class GVCItemGrenade_HundF extends Item
{
    private static final String __OBFID = "CL_00000069";

    public GVCItemGrenade_HundF()
    {
        this.maxStackSize = 4;
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        {
            par2World.spawnEntityInWorld(new GVCEntityGrenade_HundF(par2World, par3EntityPlayer));
        }
