...
import net.minecraft.inventory.Slot;
	...
	public class GVCItemM320 extends GVCItemGunBaseGL {
		...
		public void FireGrenadeBulletDart(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) 
		{
            ...
            for(int i = 0; i < 8 ; ++i)
            {
            	GVCEntityBulletDart var8 = new GVCEntityBulletDart(par2World,(EntityLivingBase) par3EntityPlayer, this.powordart, this.speed, this.bure*10);
              if (!par2World.isRemote)
              {
               par2World.spawnEntityInWorld(var8);
              }
