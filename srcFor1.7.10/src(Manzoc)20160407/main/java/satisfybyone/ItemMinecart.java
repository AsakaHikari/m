...
public class ItemMinecart extends Item {
	private static final IBehaviorDispenseItem dispenserMinecartBehavior = new BehaviorDefaultDispenseItem() {
		...
		public ItemStack dispenseStack(IBlockSource p_82487_1_,
			...
			EnumFacing enumfacing = BlockDispenser.func_149937_b(p_82487_1_
					.getBlockMetadata());
			World world = p_82487_1_.getWorld();
			double d0 = p_82487_1_.getX()
					+ (double) ((float) enumfacing.getFrontOffsetX() * 1.125F);
			double d1 = p_82487_1_.getY()
					+ (double) ((float) enumfacing.getFrontOffsetY() * 1.125F);
			double d2 = p_82487_1_.getZ()
					+ (double) ((float) enumfacing.getFrontOffsetZ() * 1.125F);
			...
			if (BlockRailBase.func_150051_a(block)) {
				...
				if (block.getMaterial() != Material.air
						|| !BlockRailBase.func_150051_a(world.getBlock(i,
								j - 1, k))) {
					return this.behaviourDefaultDispenseItem.dispense(
							p_82487_1_, p_82487_2_);
				}

				d3 = -1.0D;
			}

			EntityMinecart entityminecart = new EntityManzocCart(world, d0, d1
					+ d3, d2);
	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_,
		...
		if (BlockRailBase.func_150051_a(p_77648_3_.getBlock(p_77648_4_,
			...
			if (!p_77648_3_.isRemote) {
				...
				switch (minecartType) {
				case 0:
					entityminecart = new EntityManzocCart(p_77648_3_,
