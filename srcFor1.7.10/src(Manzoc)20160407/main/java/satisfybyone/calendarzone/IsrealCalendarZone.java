...
public class IsrealCalendarZone extends CalendarZone {
	public IsrealCalendarZone(String[][] cities) {
		super(cities);
	...
	public List<String> getManzocCitiesOnThirtyMinutes(Calendar calendar,
		...
		summerTimeStart
				.set(Calendar.DAY_OF_WEEK_IN_MONTH, 3);

		Calendar summerTimeEnd = new GregorianCalendar(
				calendar.get(Calendar.YEAR), Calendar.OCTOBER, 1, 2, 0);
