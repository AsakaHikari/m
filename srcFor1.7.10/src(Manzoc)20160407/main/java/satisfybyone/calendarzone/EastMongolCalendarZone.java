...
public class EastMongolCalendarZone extends CalendarZone {
	public EastMongolCalendarZone(String[][] cities) {
		super(cities);
	...
	public List<String> getManzocCitiesOnThirtyMinutes(Calendar calendar,
		...
		summerTimeStart.set(Calendar.DAY_OF_WEEK, Calendar.SATURDAY);
		summerTimeStart
		...
		Calendar summerTimeEnd = new GregorianCalendar(
				calendar.get(Calendar.YEAR), Calendar.SEPTEMBER, 1, 0, 0);
		summerTimeEnd.set(Calendar.DAY_OF_WEEK, Calendar.SATURDAY);
		summerTimeEnd
				.set(Calendar.DAY_OF_WEEK_IN_MONTH, summerTimeStart
						.getActualMaximum(Calendar.DAY_OF_WEEK_IN_MONTH));
