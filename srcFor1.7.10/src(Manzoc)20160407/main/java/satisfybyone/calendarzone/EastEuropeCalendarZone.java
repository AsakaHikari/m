...
public class EastEuropeCalendarZone extends CalendarZone {
	public EastEuropeCalendarZone(String[][] cities) {
		super(cities);
	...
	public List<String> getManzocCitiesOnThirtyMinutes(Calendar calendar,
		...
		Calendar summerTimeStart = new GregorianCalendar(
				calendar.get(Calendar.YEAR), Calendar.MARCH, 1, 3, 0);
		...
		Calendar summerTimeEnd = new GregorianCalendar(
				calendar.get(Calendar.YEAR), Calendar.OCTOBER, 1, 3, 0);
