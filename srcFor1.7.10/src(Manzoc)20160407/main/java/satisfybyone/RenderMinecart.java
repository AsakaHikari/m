...
public class RenderMinecart extends Render {
	private static final ResourceLocation minecartTextures = new ResourceLocation(
			"manzoc:textures/entity/minecart.png");
	/** instance of ModelMinecart for rendering */
	protected ModelBase modelMinecart = new ModelManzocCart();
	...
	public void doRender(EntityMinecart p_76986_1_, double p_76986_2_,
		...
		double d3 = p_76986_1_.lastTickPosX
				+ (p_76986_1_.posX - p_76986_1_.lastTickPosX)
				* (double) p_76986_9_;
		double d4 = p_76986_1_.lastTickPosY
				+ (p_76986_1_.posY - p_76986_1_.lastTickPosY)
				* (double) p_76986_9_;
		double d5 = p_76986_1_.lastTickPosZ
				+ (p_76986_1_.posZ - p_76986_1_.lastTickPosZ)
				* (double) p_76986_9_;
		...
		if (vec3 != null) {
			...
			Vec3 vec33 = vec32.addVector(-vec31.xCoord, -vec31.yCoord,
					-vec31.zCoord);
		...
		if (f7 > 0.0F) {
			GL11.glRotatef(MathHelper.sin(f7) * f7 * f8 / 10.0F
					* (float) p_76986_1_.getRollingDirection(), 1.0F, 0.0F,
					0.0F);
		}
		...
		this.modelMinecart.render(p_76986_1_, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F,
				0.0625F);
		GL11.glPopMatrix();
	}
