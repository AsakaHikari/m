...
public class EntityRubberBall extends EntityShell{
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2)
    {
        ...
        else
        {
            ...
            {
            	if(!this.worldObj.isRemote&&!((EntityPlayer)par1DamageSource.getSourceOfDamage()).capabilities.isCreativeMode)this.entityDropItem(new ItemStack(ShellCore.itemShell,1,3), 0.0f);
                this.setDead();
                return true;
            }
            else
