...
public class WorldChunkManagerDesert extends WorldChunkManager{
    ...
    protected WorldChunkManagerDesert()
    {
    ...
    public WorldChunkManagerDesert(long par1, WorldType par3WorldType)
    {
        this();
        GenLayer[] var4 = GenLayerDesert.initializeAllBiomeGenerators(par1, par3WorldType);
        var4 = getModdedBiomeGenerators(par3WorldType, par1, var4);
        this.genBiomes = var4[0];
        this.biomeIndexLayer = var4[1];
    }

    public WorldChunkManagerDesert(World par1World)
    {
