...
public class EntityTracer extends Entity {
	...
	public void onUpdate(){
		super.onUpdate();
		if(!this.worldObj.isRemote && (this.traceTarget==null || this.traceTarget.isDead)){
			this.setDead();
			return;
		}
		...
		if(this.worldObj.isRemote && this.getSmoke()){
	...
	public void makeTicket(){
		if(this.ticket==null){
			ForgeChunkManager.Ticket chunkTicket=ForgeChunkManager.requestTicket(CannonCore.instance, this.worldObj, ForgeChunkManager.Type.ENTITY);
			if (chunkTicket != null)
			{
