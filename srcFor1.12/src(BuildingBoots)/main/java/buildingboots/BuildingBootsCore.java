...
/*    */public class BuildingBootsCore{
	...
	/*    */{
		...
		//GameRegistry.addShapedRecipe(new ResourceLocation(""),new ResourceLocation(""),new ItemStack(itembuildingboots_0), "X X","XYX",'X',Blocks.COBBLESTONE,'Y',Items.IRON_BOOTS);
		//GameRegistry.addShapedRecipe(new ResourceLocation(""),new ResourceLocation(""),new ItemStack(itembuildingboots_1), "X X","XYX",'X',Blocks.STONEBRICK,'Y',itembuildingboots_0);
		//GameRegistry.addShapedRecipe(new ResourceLocation(""),new ResourceLocation(""),new ItemStack(itembuildingboots_2), "X X","XYX",'X',Blocks.BRICK_BLOCK,'Y',itembuildingboots_1);
	...
	public static void registerModels(ModelRegistryEvent event) {
		...
		ModelLoader.setCustomModelResourceLocation(itembuildingboots_0, 0, new ModelResourceLocation(itembuildingboots_0.getRegistryName(), "inventory"));
		ModelLoader.setCustomModelResourceLocation(itembuildingboots_1, 0, new ModelResourceLocation(itembuildingboots_1.getRegistryName(), "inventory"));
		ModelLoader.setCustomModelResourceLocation(itembuildingboots_2, 0, new ModelResourceLocation(itembuildingboots_2.getRegistryName(), "inventory"));
	}
}
