...
public class BlockPistonBaseAlter extends BlockPistonBase
{
    ...
    public BlockPistonBaseAlter(boolean isSticky)
    {
        super(isSticky);
    ...
    private void checkForMove(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        {
            if ((new BlockPistonStructureHelperAlter(worldIn, pos, enumfacing, true)).canMove())
            {
    ...
    private boolean doMove(World worldIn, BlockPos pos, EnumFacing direction, boolean extending)
    {
        ...
        BlockPistonStructureHelperAlter blockpistonstructurehelper = new BlockPistonStructureHelperAlter(worldIn, pos, direction, extending);
