...
public class RenderShell extends Render
{
    ...
    private ResourceLocation tex = new ResourceLocation("crowbarmodfromrailcraft:textures/entity/chunk_loader.png");

    public RenderShell(String texturePath,RenderManager m)
    {
    	super(m);
