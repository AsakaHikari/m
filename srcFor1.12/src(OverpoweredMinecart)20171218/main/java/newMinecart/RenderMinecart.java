...
public class RenderMinecart<T extends EntityMinecartRapid> extends Render<T>
{
    private static final ResourceLocation MINECART_TEXTURES = new ResourceLocation("newMinecart:textures/entity/minecart.png");
