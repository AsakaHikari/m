...
public class EntityHugeHE extends EntityHE{
	public EntityHugeHE(World par1World) {
		super(par1World);
	...
	public EntityHugeHE(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.setSize(2.98F, 2.98F);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2)
    {
        ...
        else
        {
            ...
            {
            	if(!this.worldObj.isRemote&&!((EntityPlayer)par1DamageSource.getSourceOfDamage()).capabilities.isCreativeMode)this.entityDropItem(new ItemStack(ShellCore.itemShell.itemID,1,6), 0.0f);
                this.setDead();
                return true;
            }
            else
